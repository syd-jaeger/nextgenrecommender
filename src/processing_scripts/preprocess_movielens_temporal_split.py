...
INPUT_FILE = RAW_DATA_PATH / 'movielens-32m/ratings.csv'

# Ordner, in dem train.csv, valid.csv und test.csv gespeichert werden
OUTPUT_DIR = PROCESSED_DATA_PATH / 'movielens-32m_global_temporal_split/'

# Zeitstempel Grenzen (01.01.2021)
TEST_TIMESTAMP = 1609455600
