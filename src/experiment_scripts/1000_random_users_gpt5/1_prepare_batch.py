...
CANDIDATES_LOOKUP_FILE = RERANKED_DATA_PATH / 'gpt-5_batch_candidates_lookup.json'  # Needed later for parsing

SAMPLE_SIZE = 1000
RANDOM_SEED = 42
DEPLOYMENT_NAME = "gpt-5-jonathan-batch"  # Your Azure Deployment Name
