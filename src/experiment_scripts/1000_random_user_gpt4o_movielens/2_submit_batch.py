...
# --- AZURE CONFIG ---
AZURE_ENDPOINT = "https://gpt-sweden-gotzian-reuber.openai.azure.com/openai/deployments/gpt-4o-jonathan-batch/chat/completions?api-version=2025-01-01-preview"  # YOUR ENDPOINT
AZURE_API_KEY = "eefe02fe836d4eb185d59c6865a2a912"
API_VERSION = "2025-01-01-preview"

BATCH_INPUT_FILE = PROMPTING_DATA_PATH / 'batch_input_gpt-4o-movielens-v02.jsonl'
OUTPUT_FILENAME = "batch_output_gpt-4o-movielens-v02.jsonl"  # Name to save downloaded results
