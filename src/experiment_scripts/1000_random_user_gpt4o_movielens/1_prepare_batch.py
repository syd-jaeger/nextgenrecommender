...
# --- CONFIG ---
INPUT_FILE = PROMPTING_DATA_PATH / 'movielens_prompting-data.jsonl'
BATCH_INPUT_FILE = PROMPTING_DATA_PATH / 'batch_input_gpt-4o-movielens-v02.jsonl'
CANDIDATES_LOOKUP_FILE = RERANKED_DATA_PATH / 'batch_candidates_movielens_lookup.json'  # Needed later for parsing
