...
CANDIDATES_LOOKUP_FILE = RERANKED_DATA_PATH / 'batch_candidates_movielens_lookup.json'
FINAL_CSV = RERANKED_DATA_PATH / 'sports_outdoors_reranked_azure_batch_movielens-v02.csv'
